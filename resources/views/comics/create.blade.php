...
<div class="container">
    ...
    <form action="{{route('comics.store')}}" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="thumb" name="thumb" placeholder="Inserisci l'url dell'immagine del fumetto">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input class="form-control" id="series" name="series" placeholder="Inserisci la serie del fumetto">
        </div>
        <div class="form-group">
            <label for="sale_date">Data di uscita</label>
            <input class="form-control it-date-datepicker" id="sale_date" name="sale_date" placeholder="Inserisci la data in formato gg/mm/aaaa">
        </div>
        <div class="form-group">
